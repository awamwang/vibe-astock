...
def build_budget_payload(budget_env: dict) -> dict:
    return {
        ...
        "recommended_cap_total_pct": budget_env.get("recommended_cap_total"),
        "recommended_cap_single_pct": budget_env.get("recommended_cap_single"),
        "override_cap_total_pct": budget_env.get("override_cap_total"),
        "override_cap_single_pct": budget_env.get("override_cap_single"),
