...
| [inner/specs/风格偏好.md](./inner/specs/风格偏好.md) | 短线风格页第 0 层风格偏好（仅本机 spec） |
...
| [短线情绪共振-分析方法.md](./inner/research/短线情绪共振-分析方法.md) | 超短「情绪共振」定义与可观测判定方式；对照打板情绪 / 派生指标 / Cap |
| [短线风格指数-情绪偏好轮动分析方法.md](./inner/research/短线风格指数-情绪偏好轮动分析方法.md) | 风格指数截面/轮动方法调研；第 0 层落地见 inner/specs/风格偏好.md |
